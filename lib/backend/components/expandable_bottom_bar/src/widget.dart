...
import 'package:kelide_jazzb/backend/components/expandable_bottom_bar/src/controller.dart';
...
class _BottomExpandableAppBarState extends State<BottomExpandableAppBar> {
  ...
  Widget build(BuildContext context) {
    final finalHeight = (widget.useMax && widget.constraints != null) ? widget.constraints.biggest.height : widget.expandedHeight;
...
class _BottomAppBarClipper extends CustomClipper<Path> {
  const _BottomAppBarClipper({@required this.geometry, @required this.shape, @required this.notchMargin, @required this.buttonOffset})
