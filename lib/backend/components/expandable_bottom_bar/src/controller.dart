...
class BottomBarController extends ChangeNotifier {
  ...
  var currentState = BehaviorSubject<bool>.seeded(false);

  Observable get stream => currentState.stream;

  bool get openState => _animationController?.value == 1.0 ? true : false;
...
class DefaultBottomBarController extends StatefulWidget {
  ...
  static BottomBarController of(BuildContext context) {
    final _BottomBarControllerScope scope = context.inheritFromWidgetOfExactType(_BottomBarControllerScope);
